      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="row m-auto ">
                  ...
                  <div className="col-md-2 responvm">
                    ...
                    >
                      ...
                      <div className="row m-auto text-center fnt14 textsi mt-2 clr3  boldt">
                        <span className="m-auto text-center fnt14 textsi mt-2 clr3  boldt">
                          {ele?.category}
                        </span>
                      </div>{" "}
                    </Link>{" "}
            ...
            <div className="row m-auto mt-5 commercial-bg p-4">
            ...
            <div className="row m-auto mt-5 p-4">
